...
namespace AssetBundleBrowser
{
    ...
    public class AssetBundleBrowserMain : EditorWindow, IHasCustomMenu, ISerializationCallbackReceiver
    {
        ...
        private UpLoadABEditor m_UpLoadABTab;
        ...
        private void OnEnable()
        {
            ...
            if (m_UpLoadABTab == null)
            {
                m_UpLoadABTab = new UpLoadABEditor();
                m_UpLoadABTab.OnEnable(this);
            }
        ...
        void ModeToggle()
        {
            ...
            bool clicked = false;
            if (m_RefreshTexture == null) m_RefreshTexture = EditorGUIUtility.FindTexture("Refresh");
            switch (m_Mode)
            {
                case Mode.Browser:
